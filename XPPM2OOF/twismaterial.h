...
#ifndef TWISMATERIAL_H
#define TWISMATERIAL_H

#include "material.h"
#include "menuDef.h"


class TwisMaterial : public Material {
protected:
  static float young_dflt, poisson_dflt, t_coeff_dflt, sfs_coeff_dflt;
  float young, poisson, t_coeff, sfs_coeff;
#ifdef THERMAL
...
public:
  ...
  virtual void AddArgs(CommandM *cmd) {
    ...
    AddArgument(cmd, "vegard", sfs_coeff_dflt);
#ifdef THERMAL
