...
#ifndef GRADYELEMENT_H
#define GRADYELEMENT_H

class GradyElement;

#include "genelement.h"

class GradyElement : public GTElement {
protected:
  double c11, c12, c13, c16, c33, c44, c66;
  static double c11_dflt, c12_dflt, c13_dflt, c16_dflt, c33_dflt,
    c44_dflt, c66_dflt;
  double alpha11, alpha33, alpha13, alpha23;
  static double alpha11_dflt, alpha33_dflt, alpha13_dflt, alpha23_dflt;
#ifdef THERMAL
...
public:
  ...
  static void AddArgs(CommandM *cmd) {
    ...
    AddArgument(cmd, "alpha13", alpha13_dflt);
    AddArgument(cmd, "alpha23", alpha23_dflt);
#ifdef THERMAL
