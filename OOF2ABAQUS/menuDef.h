...
protected:
  ...
  TrueFalse no_error_msgs;	// hack added for oof2abaqus
...
public:
 ...
 // 0 for Waiters for which this doesn't make sense
  ...
  void errors_off() { no_error_msgs = 1; } // hack added for oof2abaqus
  void errors_on() { no_error_msgs = 0; } // hack added for oof2abaqus
